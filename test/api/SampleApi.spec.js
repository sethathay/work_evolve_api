...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WorkEvolveApi.SampleApi();
  });
  ...
  describe('SampleApi', function() {
    describe('getSample', function() {
      it('should call getSample successfully', function(done) {
        //uncomment below and update the code to test getSample
        //instance.getSample(function(error) {
